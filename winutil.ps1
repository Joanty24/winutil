                    ...
                    <TabItem Header="Tweaks" Visibility="Collapsed" Name="WPFTab2">
                        <Grid Background="#333333">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" Orientation="Horizontal" Grid.Row="0" HorizontalAlignment="Center" Grid.Column="1" Margin="9">
                                <Label Content="Configuracio:" FontSize="17" VerticalAlignment="Center"/>
                                <Button Name="WPFimport" Content=" Importar " Margin="7"/>
                                <Button Name="WPFexport" Content=" Exportar " Margin="7"/>
                            </StackPanel>
