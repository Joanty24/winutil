                ...
                <TabControl Grid.Row="1" Padding="-1" Name="WPFTabNav" Background="#222222">
                    <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                        <Grid Background="#222222">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" Orientation="Horizontal" Grid.Row="3" HorizontalAlignment="Center" Grid.Column="4" Grid.ColumnSpan="4" Margin="9">
                                <TextBlock Padding="9">
                    ...
                    <TabItem Header="Updates" Visibility="Collapsed" Name="WPFTab4">
                        <Grid Background="#555555">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Column="2" Margin="10,5">
                                ...
                                <TextBlock Margin="20,0,20,0" Padding="9" TextWrapping="WrapWithOverflow" MaxWidth="300">This completely disables ALL Windows Updates and is NOT RECOMMENDED.<LineBreak/><LineBreak/> However, it can be suitable if you use your system for a select purpose and do not actively browse the internet. <LineBreak/><LineBreak/>Note: Your system will be easier to hack and infect without security updates.</TextBlock>
